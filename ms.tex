...
\begin{figure}[ht!]
\epsscale{0.7}
%\plotone{plots/slv1coadd.pdf}
%\plotone{plots/slv2coadd.pdf}
%\plotone{plots/onewcoadd.pdf}\\
...
XXX--the top panels have more info, but I kinda like the lower for the simplicity. Maybe just the lower and say all the filters follow a similar trend? Or a plot for g and a plot for i?
xxx--MR deleted the top panels, and thinks we should avoid discussing filters/bands too much because people will ask whether we are simulating sat brightness as a function of wavelength... which we definitely aren't}
\end{figure}
