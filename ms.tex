...
Observatory \citep{lawrence22}. % XXX-but, our results say OneWeb streaks 10% of Rubin images. We shouldn't repeat claims we know are wrong. And this is just citing tyson20, which does not say the majority of exposures would have a streak. 
...
\begin{figure}[ht!]
\epsscale{0.5}
%% XXX--ugh, so these have enough points that they take forever to render. Thoughts on how to improve welcome
...
\begin{figure}[ht!]
\plottwo{plots/nexp_v_weight.pdf}{plots/streakfrac_v_weight.pdf}
\plottwo{plots/streaklen_v_weight.pdf}{plots/streak_length_v_deltam.pdf}
