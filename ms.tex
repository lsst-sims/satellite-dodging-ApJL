...
XXX--I'll add some text describing the baseline scheduler that we use--note that we only run for the first year. As a starting point we use the baseline scheduler simulation in \citet{yoachim2022}.
